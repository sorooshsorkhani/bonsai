...
def greet(state):
    ...
    🌍 I'm BONsAI – the assistant for GEO BON members.  
    ...
    - I couldn't retrieve the information even though it should be available. You might want to try rewording your query. If you think the information should have been found, please provide feedback by clicking the thumbs down button – your input helps us improve!

    ---

    ### 👍👎 Feedback:
    If you would like to give feedback on my response, you can use the **thumbs up (👍)** or **thumbs down (👎)** buttons. If you choose the thumbs down, you will have the option to add an additional comment. Your feedback helps us improve.
    ...
    🌱 **Sustainability Note:** This message was crafted manually rather than being generated by a Large Language Model. This helps reduce energy consumption and minimizes environmental impact.

    ---

    💬 Let me know what's on your mind, or if you have any questions I can help with!
    """
        )
    ]
