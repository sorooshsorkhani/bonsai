...
def greet(state):
    ...
    For now, your responsibility is solely to respond to users' greetings or explain to them what BONsAI can do for them.
    ...
    Look at the user's query and respond to them properly.\n 
